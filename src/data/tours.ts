...
export const featured: Tour[] = [
  ...
  { title: "Xinjiang Group Tour to Kashgar & Kanas", slug: "11d-kashgar-kanas", duration: "11 Days", route: "Kashgar → Taxkorgan → Urumqi → Turpan → Beitun → Hemu → Kanas → Urho", image: "/assets/images/central-asia-architecture.jpg", features: ["⭐ 4-Star Hotels", "🎓 English Guide", "✈ Flight Included"], price: "$1,780", originalPrice: "$1,970" },
  ...
  { title: "Silk Road Group Tour to Gansu & Qinghai", slug: "7d-gansu-qinghai", duration: "7 Days", route: "Dunhuang → Jiayuguan → Zhangye → Xining → Chaka", image: "/assets/images/hero-mountains.jpg", features: ["⭐ 4-Star Hotels", "🎓 English Guide"], price: "$980", originalPrice: "$1,080" },
];
...
export const extend: Tour[] = [
  { title: "Beijing, Chengdu, Zhangjiajie &amp; Shanghai Tour", slug: "beijing-chengdu-zhangjiajie-shanghai", duration: "12 Days", route: "Classic China highlights", image: "/assets/images/hero-silkroad.jpg" },
  ...
  { title: "Silk Road &amp; Tibet Adventure", slug: "silk-road-tibet-adventure", duration: "15 Days", route: "Ancient trade routes meet the roof of the world", image: "/assets/images/hero-silkroad.jpg" },
